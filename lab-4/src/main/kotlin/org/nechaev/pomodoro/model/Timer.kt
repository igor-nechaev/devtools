...
data class Timer(
    ...
    @Schema(
        example = "1230",
        required = true,
        description = "Оставшееся время в секундах. Вычисляется динамически с учётом всех запусков и пауз. Для запущенного таймера пересчитывается при каждом запросе. "
    )
